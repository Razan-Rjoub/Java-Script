...
const obj1 = { name: "Razan", age: 21, city: "Irbid" };
const obj2 = { name: "Razan", age: 21, city: "Irbid" };
const obj3 = { name: "Rama", age: 23, city: "Amman" };
...
document.getElementById("copyclip")
...
csvToObject =(csv)=> {
  ...
  const titleRow = rows.shift().split(',');
